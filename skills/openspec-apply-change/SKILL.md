...
description: Implement tasks from an OpenSpec change. Requires the OpenSpec CLI. Use when the user wants to start implementing, continue implementation, or work through tasks.
license: MIT
metadata:
  author: openspec
  version: "1.0"
...
1. **Select the change**
   ...
   - If ambiguous, run `openspec list --json` and ask the user to select a change
