...
- [security.md](../../ume-conventions/references/security.md) for security or data-exposure rules;
- [simplicity.md](../../ume-conventions/references/simplicity.md) for a verified, concrete simplification or a comment/knowledge-placement rule;
- [naming.md](../../ume-conventions/references/naming.md) for naming or glossary rules;
- [python.md](../../ume-conventions/references/python.md), [fastapi.md](../../ume-conventions/references/fastapi.md), [django.md](../../ume-conventions/references/django.md), [typescript.md](../../ume-conventions/references/typescript.md), or [react.md](../../ume-conventions/references/react.md) for language/framework rules;
- [testing.md](../../ume-conventions/references/testing.md) for test-evidence, oracle, isolation, or boundary rules;
...
- After the arrow, write a plain-language summary that states the concrete
  problem. Never use a mechanical rule ID, linter code, test name, or other
  tooling identifier as the finding summary. Such identifiers are internal
  metadata and may be recorded in the checks/evidence section.
- Include a changed file and line when the finding has a location. Use a general finding only when no line can carry it.
- Quote only the minimum changed code needed to identify the issue. Keep quoted
  code, identifiers, paths, commands, URLs, and raw excerpts byte-for-byte
  unchanged. Mask secret-shaped values before output or posting.
...
- In the assessment, explain why the code is wrong, why the convention applies,
  and why it matters. Do not write a vague “consider” suggestion.
